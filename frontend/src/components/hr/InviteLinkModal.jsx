    ...
    <Modal
      ...
      description={
        regenerated
          ...
          : 'One invitation email covering documents and the offer letter has been sent.'
      }
      size="md"
      footer={<Button onClick={onClose}>Done</Button>}
    >
      <div className="space-y-4">
        <div className="rounded border border-accent-green/30 bg-[#F3FCF7] px-4 py-3">
          <p className="text-[13px] text-ink-body">
            {invitation.sentAt ? (
              ...
              <>
                ...
                resend it from the candidate's record.
              </>
            )}
          </p>
        </div>
        ...
        <dl className="grid gap-3 text-[12.5px] sm:grid-cols-2">
          <div className="rounded border border-surface-line bg-surface-canvas px-3 py-2.5">
        ...
        <p className="text-[12px] leading-5 text-ink-muted">
          You can read this link again later from the candidate's Details tab, or resend the invitation
          email. Treat it like a password - it opens their onboarding.
        </p>
      </div>
    </Modal>
  )
